...
class CharacterChatBot():
    ...
    def __init__(self,
                 model_path,
                 data_path="/content/data/blackclover.csv",
    ...
    def chat(self, message, history):
        ...
        messages.append({"role":"system","content":""""Your are Black Clover from the anime "Black Clover". Your responses should reflect his personality and speech patterns \n"""})
    ...
    def load_data(self):
        blackclover_transcript_df = pd.read_csv(self.data_path)
        blackclover_transcript_df = blackclover_transcript_df.dropna()
        blackclover_transcript_df['line'] = blackclover_transcript_df['line'].apply(remove_paranthesis)
        ...
        blackclover_transcript_df.loc[(blackclover_transcript_df['name']=="Black Clover")&(blackclover_transcript_df['number_of_words']>5),'blackclover_response_flag']=1
